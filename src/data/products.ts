...
- 持续的技术升级服务
  ...
  },
  {
    ...
    sales: 0,
    createdAt: '2024-03-22',
    image: '/images/products/矿卡专用控制阀组/1.jpg',
    images: Array.from({ length: 6 }, (_, i) => `/images/products/矿卡专用控制阀组/${i + 1}.jpg`),
    specs: [
...
- **高效稳定：** 全系统解决方案，实景模拟调试，保证产品一致性。
  ...
  {
    id: 'p-zhonglian-zhebi',
    name: '重庆中联折臂吊吊臂组装调试液压站',
    model: 'HS-ZL-ZHEBI',
    category: 'zhonglian-zhebi',
    brand: '其他',
    price: 0,
    rating: 5.0,
    sales: 0,
    createdAt: '2024-03-22',
    image: '/images/products/液压站/重庆中联折臂吊吊臂组装调试液压站 - 产线液压站/1.jpg',
    images: Array.from({ length: 5 }, (_, i) => `/images/products/液压站/重庆中联折臂吊吊臂组装调试液压站 - 产线液压站/${i + 1}.jpg`),
    specs: [
      { label: '产品类型', value: '液压泵站（产线）' },
      { label: '应用场景', value: '折臂吊吊臂组装调试' },
      { label: '系统特点', value: '专业定制' },
    ],
    description: '重庆中联折臂吊吊臂组装调试液压站，为折臂吊吊臂组装调试提供专业液压动力解决方案。',
    features: ['专业定制', '稳定可靠', '高效作业', '品质保障']
  },
  {
    id: 'p-feiyi-fangbao',
    name: '飞翼股份防爆液压站',
    model: 'HS-FY-FANGBAO',
    category: 'feiyi-fangbao',
    brand: '其他',
    price: 0,
    rating: 5.0,
    sales: 0,
    createdAt: '2024-03-22',
    image: '/images/products/液压站/飞翼股份防爆液压站 - 矿山液压站/1.jpg',
    images: Array.from({ length: 3 }, (_, i) => `/images/products/液压站/飞翼股份防爆液压站 - 矿山液压站/${i + 1}.jpg`),
    specs: [
      { label: '产品类型', value: '矿山井下防爆' },
      { label: '防爆等级', value: '矿山防爆标准' },
      { label: '应用场景', value: '矿山井下作业' },
    ],
    description: '飞翼股份防爆液压站，专为矿山井下防爆环境设计，满足严格的矿山安全标准。',
    features: ['防爆设计', '安全可靠', '适应性强', '品质保障']
  },
  {
    id: 'p-hedun-shuili',
    name: '河盾水利液压站',
    model: 'HS-HD-SHUILI',
    category: 'hedun-shuili',
    brand: '其他',
    price: 0,
    rating: 5.0,
    sales: 0,
    createdAt: '2024-03-22',
    image: '/images/products/液压站/河盾水利液压站 - 水利液压站/1.jpg',
    images: Array.from({ length: 3 }, (_, i) => `/images/products/液压站/河盾水利液压站 - 水利液压站/${i + 1}.jpg`),
    specs: [
      { label: '产品类型', value: '水利液压站' },
      { label: '应用场景', value: '水利液压启闭机' },
      { label: '系统特点', value: '专业定制' },
    ],
    description: '河盾水利液压站，专为水利液压启闭机设计，提供稳定可靠的水利工程液压解决方案。',
    features: ['水利专用', '稳定可靠', '耐腐蚀', '品质保障']
  },
  {
    id: 'p-hunan-yatai',
    name: '湖南亚太实业大型发泡产线液压及电控系统',
    model: 'HS-HN-YATAI',
    category: 'hunan-yatai',
    brand: '其他',
    price: 0,
    rating: 5.0,
    sales: 0,
    createdAt: '2024-03-22',
    image: '/images/products/液压站/湖南亚太实业大型发泡产线液压及电控系统 - 产线液压站/1.jpg',
    images: Array.from({ length: 8 }, (_, i) => `/images/products/液压站/湖南亚太实业大型发泡产线液压及电控系统 - 产线液压站/${i + 1}.jpg`),
    specs: [
      { label: '产品类型', value: '产线液压站' },
      { label: '应用场景', value: '大型发泡产线' },
      { label: '系统配置', value: '液压及电控系统' },
    ],
    description: '湖南亚太实业大型发泡产线液压及电控系统，为大型发泡生产线提供完整的液压和电控解决方案。',
    features: ['系统集成', '自动化控制', '高效稳定', '品质保障']
  },
  {
    id: 'p-jiaerhua-dongbi',
    name: '佳尔华动臂塔机液压站',
    model: 'HS-JEH-DONGBI',
    category: 'jiaerhua-dongbi',
    brand: '其他',
    price: 0,
    rating: 5.0,
    sales: 0,
    createdAt: '2024-03-22',
    image: '/images/products/液压站/佳尔华动臂塔机液压站 - 动臂塔机/1.jpg',
    images: Array.from({ length: 6 }, (_, i) => `/images/products/液压站/佳尔华动臂塔机液压站 - 动臂塔机/${i + 1}.jpg`),
    specs: [
      { label: '产品类型', value: '动臂塔机' },
      { label: '应用场景', value: '动臂塔机液压系统' },
      { label: '系统特点', value: '高效稳定' },
    ],
    description: '佳尔华动臂塔机液压站，为动臂塔机提供专业液压动力系统，适配各类动臂塔机需求。',
    features: ['专业适配', '高效稳定', '精准控制', '品质保障']
  },
  {
    id: 'p-qita-yeyazhan',
    name: '其他液压站',
    model: 'HS-QITA',
    category: 'qita-yeyazhan',
    brand: '其他',
    price: 0,
    rating: 5.0,
    sales: 0,
    createdAt: '2024-03-22',
    image: '/images/products/液压站/其他液压站/1.jpg',
    images: Array.from({ length: 8 }, (_, i) => `/images/products/液压站/其他液压站/${i + 1}.jpg`),
    specs: [
      { label: '产品类型', value: '其他液压站' },
      { label: '定制服务', value: '支持各类定制' },
      { label: '应用领域', value: '各类工业设备' },
    ],
    description: '其他液压站产品，提供各类定制液压站解决方案，满足不同客户的特殊需求。',
    features: ['灵活定制', '品质保障', '广泛应用', '专业服务']
  },
  {
    id: 'p-sanyi-sytb500',
    name: '三一SYTB500液压站',
    model: 'HS-SY-SYTB500',
    category: 'sanyi-sytb500',
    brand: '其他',
    price: 0,
    rating: 5.0,
    sales: 0,
    createdAt: '2024-03-22',
    image: '/images/products/液压站/三一SYTB500液压站 - 动臂塔机/1.jpg',
    images: ['/images/products/液压站/三一SYTB500液压站 - 动臂塔机/1.jpg'],
    specs: [
      { label: '产品类型', value: '动臂塔机' },
      { label: '型号', value: 'SYTB500' },
      { label: '系统特点', value: '高效稳定' },
    ],
    description: '三一SYTB500液压站，专为三一SYTB500型号动臂塔机设计，提供专业的液压动力支持。',
    features: ['原装适配', '高效稳定', '品质保障', '原厂服务']
  },
  {
    id: 'p-sanyi-txl63',
    name: '三一TXL63顶升泵站',
    model: 'HS-SY-TXL63',
    category: 'sanyi-txl63',
    brand: '其他',
    price: 0,
    rating: 5.0,
    sales: 0,
    createdAt: '2024-03-22',
    image: '/images/products/液压站/三一TXL63顶升泵站 - 液压站/1.jpg',
    images: Array.from({ length: 4 }, (_, i) => `/images/products/液压站/三一TXL63顶升泵站 - 液压站/${i + 1}.jpg`),
    specs: [
      { label: '产品类型', value: '液压站' },
      { label: '型号', value: 'TXL63' },
      { label: '应用场景', value: '顶升泵站' },
    ],
    description: '三一TXL63顶升泵站，为塔机顶升作业提供稳定可靠的液压动力，满足三一TXL63顶升需求。',
    features: ['专业顶升', '稳定可靠', '精准控制', '品质保障']
  },
  {
    id: 'p-sanyi-bianfu',
    name: '三一变幅塔机液压站',
    model: 'HS-SY-BIANFU',
    category: 'sanyi-bianfu',
    brand: '其他',
    price: 0,
    rating: 5.0,
    sales: 0,
    createdAt: '2024-03-22',
    image: '/images/products/液压站/三一变幅塔机液压站 - 动臂塔机/1.jpg',
    images: Array.from({ length: 15 }, (_, i) => `/images/products/液压站/三一变幅塔机液压站 - 动臂塔机/${i + 1}.jpg`),
    specs: [
      { label: '产品类型', value: '动臂塔机' },
      { label: '应用场景', value: '变幅塔机液压系统' },
      { label: '系统特点', value: '高效稳定' },
    ],
    description: '三一变幅塔机液压站，专为三一变幅塔机设计，提供专业的变幅液压动力系统。',
    features: ['专业适配', '高效稳定', '精准变幅', '品质保障']
  },
  {
    id: 'p-sileng-yaozhu',
    name: '四棱数控300T压铸机',
    model: 'HS-SL-YAOZHU',
    category: 'sileng-yaozhu',
    brand: '其他',
    price: 0,
    rating: 5.0,
    sales: 0,
    createdAt: '2024-03-22',
    image: '/images/products/液压站/四棱数控300T压铸机 - 液压泵站/1.jpg',
    images: Array.from({ length: 6 }, (_, i) => `/images/products/液压站/四棱数控300T压铸机 - 液压泵站/${i + 1}.jpg`),
    specs: [
      { label: '产品类型', value: '液压泵站' },
      { label: '型号', value: '300T压铸机' },
      { label: '应用场景', value: '压铸设备' },
    ],
    description: '四棱数控300T压铸机液压站，专为300T压铸机设计，提供稳定可靠的液压动力系统。',
    features: ['专业压铸', '高效稳定', '精准控制', '品质保障']
  },
  {
    id: 'p-yuqian-yeya',
    name: '宇乾智能液压泵站',
    model: 'HS-YQ-YEYA',
    category: 'yuqian-yeya',
    brand: '其他',
    price: 0,
    rating: 5.0,
    sales: 0,
    createdAt: '2024-03-22',
    image: '/images/products/液压站/宇乾智能  - 产线液压站/1.jpg',
    images: Array.from({ length: 7 }, (_, i) => `/images/products/液压站/宇乾智能  - 产线液压站/${i + 1}.jpg`),
    specs: [
      { label: '产品类型', value: '液压泵站（产线）' },
      { label: '应用场景', value: '智能产线' },
      { label: '系统特点', value: '自动化控制' },
    ],
    description: '宇乾智能液压泵站，为智能产线提供专业液压动力系统，实现高效自动化生产。',
    features: ['智能自动化', '高效稳定', '精准控制', '品质保障']
  },
  {
    id: 'p-zhonglian-zhonglian',
    name: '中联智慧产业城液压泵站',
    model: 'HS-ZL-ZHONGZHILIAN',
    category: 'zhonglian-zhonglian',
    brand: '其他',
    price: 0,
    rating: 5.0,
    sales: 0,
    createdAt: '2024-03-22',
    image: '/images/products/液压站/中联智慧产业城 - 产线液压站/中、大、超大吨位吊臂产线液压站/1.jpg',
    images: Array.from({ length: 28 }, (_, i) => `/images/products/液压站/中联智慧产业城 - 产线液压站/中、大、超大吨位吊臂产线液压站/${i + 1}.jpg`),
    specs: [
      { label: '产品类型', value: '液压泵站（产线）' },
      { label: '应用场景', value: '中联智慧产业城产线' },
      { label: '系统配置', value: '多种规格' },
    ],
    description: '中联智慧产业城液压泵站，为中联智慧产业城提供全面的液压泵站解决方案，包含多种规格型号。',
    features: ['产线集成', '多种规格', '高效稳定', '品质保障'],
    subCategories: [
      {
        id: 'zhongda-chandui',
        name: '中、大、超大吨位吊臂产线液压站',
        model: 'HS-ZL-CHANDUI-28',
        image: '/images/products/液压站/中联智慧产业城 - 产线液压站/中、大、超大吨位吊臂产线液压站/1.jpg',
        images: Array.from({ length: 28 }, (_, i) => `/images/products/液压站/中联智慧产业城 - 产线液压站/中、大、超大吨位吊臂产线液压站/${i + 1}.jpg`),
        specs: [
          { label: '产品类型', value: '吊臂产线液压站' },
          { label: '吨位范围', value: '中、大、超大吨位' },
          { label: '图片数量', value: '28张' },
        ]
      },
      {
        id: 'xiaochache-chandui',
        name: '吊臂产线小车液压站图片',
        model: 'HS-ZL-XIAOCHE-5',
        image: '/images/products/液压站/中联智慧产业城 - 产线液压站/吊臂产线小车液压站图片/1.jpg',
        images: Array.from({ length: 5 }, (_, i) => `/images/products/液压站/中联智慧产业城 - 产线液压站/吊臂产线小车液压站图片/${i + 1}.jpg`),
        specs: [
          { label: '产品类型', value: '小车液压站' },
          { label: '应用场景', value: '吊臂产线小车' },
          { label: '图片数量', value: '5张' },
        ]
      },
      {
        id: 'lianshi-bianwei',
        name: '链式变位机泵站',
        model: 'HS-ZL-LIANSHI-1',
        image: '/images/products/液压站/中联智慧产业城 - 产线液压站/链式变位机泵站/1.jpg',
        images: ['/images/products/液压站/中联智慧产业城 - 产线液压站/链式变位机泵站/1.jpg'],
        specs: [
          { label: '产品类型', value: '链式变位机泵站' },
          { label: '应用场景', value: '变位机设备' },
          { label: '图片数量', value: '1张' },
        ]
      }
    ]
